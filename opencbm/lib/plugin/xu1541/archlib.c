...
opencbm_plugin_driver_open(CBM_FILE *HandleDevice, const char * Port)
{
    ...
    return xu1541_init((struct opencbm_usb_handle **)HandleDevice);
}
...
{
    xu1541_close((struct opencbm_usb_handle *)HandleDevice);
}
...
{
    return xu1541_write((struct opencbm_usb_handle *)HandleDevice, Buffer, Count);
}
...
{
    return xu1541_read((struct opencbm_usb_handle *)HandleDevice, Buffer, Count);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_LISTEN, DeviceAddress, SecondaryAddress);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_TALK, DeviceAddress, SecondaryAddress);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_OPEN, DeviceAddress, SecondaryAddress);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_CLOSE, DeviceAddress, SecondaryAddress);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_UNLISTEN, 0, 0);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_UNTALK, 0, 0);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_GET_EOI, 0, 0);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_CLEAR_EOI, 0, 0);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_RESET, 0, 0);
}
...
{
    return (unsigned char) xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_PP_READ, 0, 0);
}
...
{
    xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_PP_WRITE, Byte, 0);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_IEC_POLL, 0, 0);
}
...
{
    xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_IEC_SETRELEASE, Line, 0);
}
...
{
    xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_IEC_SETRELEASE, 0, Line);
}
...
{
    xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_IEC_SETRELEASE, Set, Release);
}
...
{
    return xu1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XU1541_IEC_WAIT, Line, State);
}
