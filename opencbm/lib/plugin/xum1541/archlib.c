...
opencbm_plugin_driver_open(CBM_FILE *HandleDevice, const char * const Port)
{
    ...
    return xum1541_init((struct opencbm_usb_handle **)HandleDevice, portNumber);
}
...
{
    return xum1541_write((struct opencbm_usb_handle *)HandleDevice, XUM1541_CBM, Buffer, Count);
}
...
{
    return xum1541_read((struct opencbm_usb_handle *)HandleDevice, XUM1541_CBM, Buffer, Count);
}
...
{
    return xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_GET_EOI, 0, 0);
}
...
{
    return xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_CLEAR_EOI, 0, 0);
}
...
{
    return (unsigned char) xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_PP_READ, 0, 0);
}
...
{
    xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_PP_WRITE, Byte, 0);
}
...
{
    return xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_IEC_POLL, 0, 0);
}
...
{
    xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_IEC_SETRELEASE, Line, 0);
}
...
{
    xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_IEC_SETRELEASE, 0, Line);
}
...
{
    xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_IEC_SETRELEASE, Set, Release);
}
...
{
    return xum1541_ioctl((struct opencbm_usb_handle *)HandleDevice, XUM1541_IEC_WAIT, Line, State);
}
...
{
    return xum1541_control_msg((struct opencbm_usb_handle *)HandleDevice, cmd);
}
